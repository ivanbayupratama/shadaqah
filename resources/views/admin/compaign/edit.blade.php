                ...
                @endif
                 ...
                 <div class="grid grid-cols-2 gap-4">
                       <div>
                           ...
                           <input type="text" id="title" name="title" value="{{ $campaign->title }}" class="mt-1 p-2 border border-gray-300 rounded-lg w-full" placeholder="Masukkan judul donasi">
                       </div>
                       <div>
                        ...
                        <div class="col-span-2">
                            <label for="description" class="block text-sm font-medium text-gray-700">Deskripsi</label>
                             <textarea id="description" name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan deskripsi">{{ $campaign->description }}</textarea>
                       </div>
                       <div>
                             <label for="target_amount" class="block text-sm font-medium text-gray-700">Target Dana</label>
                             <input type="number" id="target_amount" name="target_amount" value="{{  $campaign->target_amount }}" class="mt-1 p-2 border border-gray-300 rounded-lg w-full" placeholder="Masukkan target dana" step="100000">
                          </div>
                  </div>
                 <div class="mt-6 flex justify-between">
                        <button type="submit" class="px-4 py-2 bg-teal-700 text-white rounded-lg">Save</button>
                    </div>
          </div>
    </form>
 </div>
